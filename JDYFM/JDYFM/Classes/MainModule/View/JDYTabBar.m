...
#import "UIView+FLMValueOfFrame.h"
...
@property (nonatomic, weak) JDYMiddleView *middleView;
...
/**
 ...
 @return 中间的按钮控件
 */
- (JDYMiddleView *)middleView {
    if (_middleView == nil) {
        JDYMiddleView *middleView = [JDYMiddleView shareInstance];
